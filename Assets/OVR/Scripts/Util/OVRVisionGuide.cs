...
public class OVRVisionGuide : MonoBehaviour
{
    ...
    /// </summary>
    /// <returns>
    /// <c> true </c>, if fade value from rel cam position was updated, <c> false </c> otherwise.
    /// </returns>
    ...
    private bool UpdateFadeValueFromRelCamPosition ( ref Vector3 relCamPosition )
    {
        ...
        // Clip camera to min amd max values MIN 
    ...
    /// <summary>
    /// CalculateFadeValue return value tells us which axis is the furthest out, so we can tell the
    /// user which direction to go
    /// </summary>
