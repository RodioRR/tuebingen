...
public class OVRUGUI
{
    ...
    private static GameObject UIObjectManager ( GameObject gameObject, string name, float posY, string text, int fontSize )
    {
    ...
    private static GameObject ComponentComposition ( GameObject GO )
    {
        GO = new GameObject();
