...
namespace URandom
{
    public static class RandomSphere
    {
        ...
        // Marsaglia Method (1972) I use for Surface and Volume FROM http://stackoverflow.com/questions/5531827/random-point-on-a-given-sphere
        ...
        /// FROM: http://unifycommunity.com/wiki/index.php?title=UnitSphere 
        /// <summary>
        /// Returns a point on the unit sphere that is within the outer cone along the z-axis but
        /// not inside the inner cone. The resulting area describes a ring on the sphere surface.
        /// </summary>
