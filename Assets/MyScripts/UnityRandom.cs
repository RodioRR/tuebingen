...
public class UnityRandom
{
    ...
    // RANDOM POINT IN A CIRCLE centered at 0 FROM
    // http://mathworld.wolfram.com/CirclePointPicking.html Take a number between 0 and 2PI and move
    ...
    // RANDOM POINT in a DISK FROM http://mathworld.wolfram.com/DiskPointPicking.html 
    ...
    // TODO: see RandomSphere GetPointOnCap(float spotAngle, ref NPack.MersenneTwister _rand,
    ...
    // TODO: see RandomSphere public static Vector3 GetPointOnRing(float innerSpotAngle, float
    //       outerSpotAngle, ref NPack.MersenneTwister _rand, Quaternion orientation)
    ...
    // START a FLOAT SHUFFLE BAG Note the a value can be shuffled with himself 
    ...
    // START a WIGHTED FLOAT SHUFFLE BAG, the trick is the it is added many times Note the a value
    // can be shuffled with himself
